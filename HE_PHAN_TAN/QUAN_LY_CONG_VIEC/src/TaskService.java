...
public interface TaskService extends Remote {
	void addTask(String name, String description, String dueDate, int userId, int categoryId, String status)
			throws RemoteException;

	void updateTask(int id, String name, String description, String dueDate, int userId, int categoryId, String status)
			throws RemoteException;
