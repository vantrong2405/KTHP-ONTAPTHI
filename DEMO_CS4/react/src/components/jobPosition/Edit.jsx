...
export default function JobPositionEdit(props) {
  ...
  function get() {
    return Service.edit(props.match.params.jobPositionId).then(response => {
  ...
  function edit(e) {
    e.preventDefault()
    Service.edit(props.match.params.jobPositionId, jobPosition).then(() => {
          ...
          <form method="post" onSubmit={edit}>
            <div className="row">
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input readOnly id="job_position_job_position_id" name="JobPositionID" className="form-control form-control-sm" onChange={onChange} value={jobPosition.JobPositionID ?? '' } type="number" required />
