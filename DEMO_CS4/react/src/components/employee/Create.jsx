          ...
          <form method="post" onSubmit={create}>
            <div className="row">
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input id="employee_employee_id" name="EmployeeID" className="form-control form-control-sm" onChange={onChange} value={employee.EmployeeID ?? '' } type="number" required />
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input id="employee_department_id" name="DepartmentID" className="form-control form-control-sm" onChange={onChange} value={employee.DepartmentID ?? '' } type="number" required />
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input id="employee_employee_type_id" name="EmployeeTypeID" className="form-control form-control-sm" onChange={onChange} value={employee.EmployeeTypeID ?? '' } type="number" required />
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input id="employee_branch_id" name="BranchID" className="form-control form-control-sm" onChange={onChange} value={employee.BranchID ?? '' } type="number" required />
              ...
              <div className="mb-3 col-md-6 col-lg-4">
                ...
                <input id="employee_job_position_id" name="JobPositionID" className="form-control form-control-sm" onChange={onChange} value={employee.JobPositionID ?? '' } type="number" required />
