    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.video_view.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(mContext, MainYoutube.class);
                ...
                Music musicYoutube=new Music();
                musicYoutube.setKeyYoutube(singleVideo.getId());
                musicYoutube.setTenBH(singleVideo.getTitle());
